namespace CPBourg.NextGenGui.Views
{
    ...
    public static partial class LocalizationManager
    {
        private static void AddOperationsTranslations()
        {
            ...
            // Home dashboard generated labels and functional feedback.
            Op("Decrease completed sets by 1", "Diminuer les lots terminés de 1", "Voltooide sets met 1 verlagen", "Fertige Sätze um 1 verringern", "Reducir los conjuntos completados en 1", "Diminuisci i set completati di 1");
            Op("Enter completed sets", "Saisir les lots terminés", "Voltooide sets invoeren", "Fertige Sätze eingeben", "Introducir conjuntos completados", "Inserisci set completati");
            Op("Increase completed sets by 1", "Augmenter les lots terminés de 1", "Voltooide sets met 1 verhogen", "Fertige Sätze um 1 erhöhen", "Aumentar los conjuntos completados en 1", "Aumenta i set completati di 1");
            Op("Decrease preset by 1", "Diminuer l’objectif de 1", "Doel met 1 verlagen", "Vorgabe um 1 verringern", "Reducir el objetivo en 1", "Diminuisci l’obiettivo di 1");
            Op("Enter preset sets", "Saisir l’objectif de lots", "Doelsets invoeren", "Vorgabesätze eingeben", "Introducir conjuntos objetivo", "Inserisci set obiettivo");
            Op("Increase preset by 1", "Augmenter l’objectif de 1", "Doel met 1 verhogen", "Vorgabe um 1 erhöhen", "Aumentar el objetivo en 1", "Aumenta l’obiettivo di 1");
            Op("Quantity", "Quantité", "Aantal", "Menge", "Cantidad", "Quantità");
            Op("No active alerts", "Aucune alerte active", "Geen actieve meldingen", "Keine aktiven Meldungen", "No hay alertas activas", "Nessun avviso attivo");
            Op("All systems are operating normally.", "Tous les systèmes fonctionnent normalement.", "Alle systemen werken normaal.", "Alle Systeme arbeiten normal.", "Todos los sistemas funcionan con normalidad.", "Tutti i sistemi funzionano normalmente.");
            Op("{0} active alert", "{0} alerte active", "{0} actieve melding", "{0} aktive Meldung", "{0} alerta activa", "{0} avviso attivo");
            Op("{0} active alerts", "{0} alertes actives", "{0} actieve meldingen", "{0} aktive Meldungen", "{0} alertas activas", "{0} avvisi attivi");
            Op("Warnings", "Avertissements", "Waarschuwingen", "Warnungen", "Advertencias", "Avvisi");
            Op("Information", "Informations", "Informatie", "Informationen", "Información", "Informazioni");
            Op("Clear after jam", "Dégager après un bourrage", "Legen na storing", "Nach Stau leeren", "Vaciar después de un atasco", "Svuota dopo inceppamento");
            Op("Idle", "Inactif", "Inactief", "Leerlauf", "Inactivo", "Inattivo");
            Op("Loaded", "Chargé", "Geladen", "Geladen", "Cargado", "Caricato");
            Op("Paused", "En pause", "Gepauzeerd", "Pausiert", "En pausa", "In pausa");
            Op("Stopped", "Arrêté", "Gestopt", "Gestoppt", "Detenido", "Arrestato");
            Op("Completed", "Terminé", "Voltooid", "Abgeschlossen", "Completado", "Completato");
            Op("Set Completed Sets", "Définir les lots terminés", "Voltooide sets instellen", "Fertige Sätze festlegen", "Establecer conjuntos completados", "Imposta set completati");
            Op("Completed sets", "Lots terminés", "Voltooide sets", "Fertige Sätze", "Conjuntos completados", "Set completati");
            Op("Enter how many sets the machine has completed so far.", "Saisissez le nombre de lots déjà terminés par la machine.", "Voer in hoeveel sets de machine tot nu toe heeft voltooid.", "Geben Sie ein, wie viele Sätze die Maschine bisher fertiggestellt hat.", "Introduzca cuántos conjuntos ha completado la máquina hasta ahora.", "Inserisci quanti set ha completato finora la macchina.");
            Op("Set Production Preset", "Définir l’objectif de production", "Productiedoel instellen", "Produktionsvorgabe festlegen", "Establecer objetivo de producción", "Imposta obiettivo di produzione");
            Op("Sets to make", "Lots à produire", "Te maken sets", "Zu fertigende Sätze", "Conjuntos que producir", "Set da produrre");
            Op("Enter the total number of sets the machine should make.", "Saisissez le nombre total de lots que la machine doit produire.", "Voer het totale aantal sets in dat de machine moet maken.", "Geben Sie die Gesamtzahl der zu fertigenden Sätze ein.", "Introduzca el número total de conjuntos que debe producir la máquina.", "Inserisci il numero totale di set che la macchina deve produrre.");
            Op("Enter 0 for unlimited production (∞).", "Saisissez 0 pour une production illimitée (∞).", "Voer 0 in voor onbeperkte productie (∞).", "Geben Sie 0 für unbegrenzte Produktion ein (∞).", "Introduzca 0 para producción ilimitada (∞).", "Inserisci 0 per una produzione illimitata (∞).");
            Op("Preset pending: unlimited production. Select Confirm to apply the changes.", "Objectif en attente : production illimitée. Sélectionnez Confirmer pour appliquer les modifications.", "Doel in behandeling: onbeperkte productie. Selecteer Bevestigen om de wijzigingen toe te passen.", "Vorgabe ausstehend: unbegrenzte Produktion. Wählen Sie Bestätigen, um die Änderungen anzuwenden.", "Objetivo pendiente: producción ilimitada. Seleccione Confirmar para aplicar los cambios.", "Obiettivo in sospeso: produzione illimitata. Seleziona Conferma per applicare le modifiche.");
            Op("Preset pending: {0:N0} sets. Select Confirm to apply the changes.", "Objectif en attente : {0:N0} lots. Sélectionnez Confirmer pour appliquer les modifications.", "Doel in behandeling: {0:N0} sets. Selecteer Bevestigen om de wijzigingen toe te passen.", "Vorgabe ausstehend: {0:N0} Sätze. Wählen Sie Bestätigen, um die Änderungen anzuwenden.", "Objetivo pendiente: {0:N0} conjuntos. Seleccione Confirmar para aplicar los cambios.", "Obiettivo in sospeso: {0:N0} set. Seleziona Conferma per applicare le modifiche.");
            Op("Completed sets pending: {0:N0}. Select Confirm to apply the changes.", "Lots terminés en attente : {0:N0}. Sélectionnez Confirmer pour appliquer les modifications.", "Voltooide sets in behandeling: {0:N0}. Selecteer Bevestigen om de wijzigingen toe te passen.", "Fertige Sätze ausstehend: {0:N0}. Wählen Sie Bestätigen, um die Änderungen anzuwenden.", "Conjuntos completados pendientes: {0:N0}. Seleccione Confirmar para aplicar los cambios.", "Set completati in sospeso: {0:N0}. Seleziona Conferma per applicare le modifiche.");
            Op("Pause production before applying counter changes.", "Mettez la production en pause avant d’appliquer les modifications du compteur.", "Pauzeer de productie voordat u tellerwijzigingen toepast.", "Pausieren Sie die Produktion, bevor Sie Zähleränderungen anwenden.", "Pause la producción antes de aplicar los cambios del contador.", "Metti in pausa la produzione prima di applicare le modifiche al contatore.");
            Op("Counter changes confirmed: {0:N0} completed / unlimited preset.", "Modifications du compteur confirmées : {0:N0} terminés / objectif illimité.", "Tellerwijzigingen bevestigd: {0:N0} voltooid / onbeperkt doel.", "Zähleränderungen bestätigt: {0:N0} fertig / unbegrenzte Vorgabe.", "Cambios del contador confirmados: {0:N0} completados / objetivo ilimitado.", "Modifiche al contatore confermate: {0:N0} completati / obiettivo illimitato.");
            Op("Counter changes confirmed: {0:N0} completed / {1:N0} preset.", "Modifications du compteur confirmées : {0:N0} terminés / objectif {1:N0}.", "Tellerwijzigingen bevestigd: {0:N0} voltooid / doel {1:N0}.", "Zähleränderungen bestätigt: {0:N0} fertig / Vorgabe {1:N0}.", "Cambios del contador confirmados: {0:N0} completados / objetivo {1:N0}.", "Modifiche al contatore confermate: {0:N0} completati / obiettivo {1:N0}.");
            Op("Line purged. Production, completed sets, and preset were reset.", "Ligne purgée. La production, les lots terminés et l’objectif ont été réinitialisés.", "Lijn geleegd. Productie, voltooide sets en doel zijn gereset.", "Linie geleert. Produktion, fertige Sätze und Vorgabe wurden zurückgesetzt.", "Línea purgada. Se restablecieron la producción, los conjuntos completados y el objetivo.", "Linea svuotata. Produzione, set completati e obiettivo sono stati reimpostati.");
            Op("Load a job before starting production.", "Chargez une tâche avant de démarrer la production.", "Laad een taak voordat u de productie start.", "Laden Sie einen Auftrag, bevor Sie die Produktion starten.", "Cargue un trabajo antes de iniciar la producción.", "Carica un lavoro prima di avviare la produzione.");
            Op("Resolve all active errors before starting production.", "Résolvez toutes les erreurs actives avant de démarrer la production.", "Los alle actieve fouten op voordat u de productie start.", "Beheben Sie alle aktiven Fehler, bevor Sie die Produktion starten.", "Resuelva todos los errores activos antes de iniciar la producción.", "Risolvi tutti gli errori attivi prima di avviare la produzione.");
            Op("Confirm the pending counter changes before starting.", "Confirmez les modifications du compteur en attente avant de démarrer.", "Bevestig de tellerwijzigingen voordat u start.", "Bestätigen Sie vor dem Start die ausstehenden Zähleränderungen.", "Confirme los cambios pendientes del contador antes de iniciar.", "Conferma le modifiche al contatore in sospeso prima di avviare.");
            Op("Production resumed.", "Production reprise.", "Productie hervat.", "Produktion fortgesetzt.", "Producción reanudada.", "Produzione ripresa.");
            Op("Production restarted.", "Production redémarrée.", "Productie opnieuw gestart.", "Produktion neu gestartet.", "Producción reiniciada.", "Produzione riavviata.");
            Op("Production started.", "Production démarrée.", "Productie gestart.", "Produktion gestartet.", "Producción iniciada.", "Produzione avviata.");
            Op("Production paused. Select Start to resume.", "Production en pause. Sélectionnez Démarrer pour reprendre.", "Productie gepauzeerd. Selecteer Starten om te hervatten.", "Produktion pausiert. Wählen Sie Starten, um fortzufahren.", "Producción en pausa. Seleccione Iniciar para reanudar.", "Produzione in pausa. Seleziona Avvia per riprendere.");
            Op("Production stopped. Select Start to restart or Purge to reset the line.", "Production arrêtée. Sélectionnez Démarrer pour redémarrer ou Purger pour réinitialiser la ligne.", "Productie gestopt. Selecteer Starten om opnieuw te starten of Legen om de lijn te resetten.", "Produktion gestoppt. Wählen Sie Starten zum Neustart oder Leeren zum Zurücksetzen der Linie.", "Producción detenida. Seleccione Iniciar para reiniciar o Purgar para restablecer la línea.", "Produzione arrestata. Seleziona Avvia per riavviare o Spurga per reimpostare la linea.");
            Op("Production completed the preset of {0:N0} sets.", "La production a atteint l’objectif de {0:N0} lots.", "De productie heeft het doel van {0:N0} sets voltooid.", "Die Produktion hat die Vorgabe von {0:N0} Sätzen abgeschlossen.", "La producción completó el objetivo de {0:N0} conjuntos.", "La produzione ha completato l’obiettivo di {0:N0} set.");
